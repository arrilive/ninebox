        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('jefe.dashboard')" :active="request()->routeIs('jefe.dashboard')">
                        {{ __('Evaluación 9-Box') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="mr-4 text-sm text-gray-700 dark:text-gray-300">
                    <span class="font-semibold">{{ Auth::user()->apellido_paterno }} {{ Auth::user()->apellido_materno }}</span>
                    <span class="text-gray-500">| {{ Auth::user()->departamento->nombre_departamento ?? 'Sin departamento' }}</span>
                </div>
